...
yet offers more specificity and some additional entries compared to such other datasets.
...
the subject abbreviation from treaty title "Fishing for King Crab (FKC)", 
...
A multilateral treaty that is not an agreement will have this treatyID format: "SFDP_2007E2:H08F_1992A". 
This represents the acronym (SFDP),
the signature year of the amendment (2007),
the type (E = Amendment),
the number of amendment (2),
and the treatyID (H08F_1992A) of the "mother" treaty. 
